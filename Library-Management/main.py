...
firebase=firebase.FirebaseApplication("https://fir-js-d5822-default-rtdb.firebaseio.com/",None)
app = Flask(__name__)
...
def index1():
    ...
    data=firebase.get('https://fir-js-d5822-default-rtdb.firebaseio.com/Books/'+email,'')
...
def index3():
    global email
    data=firebase.get('https://fir-js-d5822-default-rtdb.firebaseio.com/Issue/'+email,'')
    if data==None:
...
def submit():
    ...
    firebase.post('https://fir-js-d5822-default-rtdb.firebaseio.com/Books/'+email, data)
    data=firebase.get('https://fir-js-d5822-default-rtdb.firebaseio.com/Books/'+email,'')
...
def submit3():
        ...
        firebase.post('https://fir-js-d5822-default-rtdb.firebaseio.com/Issue/'+email, data)
        data=firebase.get('https://fir-js-d5822-default-rtdb.firebaseio.com/Issue/'+email,'')
...
def submit4():
    ...
    list_index=0
    while True:
        firebase.put('https://fir-js-d5822-default-rtdb.firebaseio.com/Books/'+email+'/'+data_key,keys[list_index],value[list_index])
...
def submit5():
    ...
    firebase.delete('https://fir-js-d5822-default-rtdb.firebaseio.com/Books/'+email,data_key)
    data=firebase.get('https://fir-js-d5822-default-rtdb.firebaseio.com/Books/'+email,'')
    if data==None:
        return render_template('index5.html')
    l2=[]
...
def submit6():
    ...
    if request.method == 'POST':
        if 'login' in request.form:
            ...
            data=firebase.get('https://fir-js-d5822-default-rtdb.firebaseio.com/Users','')
            if data==None:
                ...
                for key,value in data.items():
                    ...
                    if value=={}:
                        for key1,value1 in value.items():
                            ...
                            #     return render_template('index6.html',message=message)
                            # else:
                                firebase.post('https://fir-js-d5822-default-rtdb.firebaseio.com/Users', input_data)
